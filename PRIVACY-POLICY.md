Privacy Policy for Solo-h-index
Effective Date: May 20, 2026

Introduction
This privacy policy explains how the Solo-h-index browser extension ("the Extension") handles user information.
Data Collection
...
The Extension does not use any third-party services, analytics, or external servers.

Data Retention
Since no data is collected, there is no data retention.
